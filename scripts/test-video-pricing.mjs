...
try {
  ...
  assert.equal(credits({ modelId: 'doubao-seedance-2-0-260128', duration: 4 }), 51);
  assert.equal(credits({ modelId: 'doubao-seedance-2-0-260128', duration: 5 }), 63);
  assert.equal(credits({ modelId: 'doubao-seedance-2-0-fast-260128', duration: 5 }), 57);
  assert.equal(credits({ modelId: 'wan2.6-i2v', resolution: '720p', duration: 5 }), 38);
  assert.equal(credits({ modelId: 'wan2.6-i2v', resolution: '1080p', duration: 10 }), 126);
  assert.equal(credits({ modelId: 'kling-video-v2-6', generateAudio: false, duration: 5 }), 32);
  assert.equal(credits({ modelId: 'kling-video-v2-6', generateAudio: true, duration: 10 }), 126);
  assert.equal(credits({ modelId: 'MiniMax-Hailuo-2.3', resolution: '768p', duration: 6 }), 26);
  assert.equal(credits({ modelId: 'MiniMax-Hailuo-2.3-Fast', resolution: '768p', duration: 6 }), 18);
  assert.equal(credits({ modelId: 'google-veo3.1', duration: 8 }), 16);
  assert.equal(credits({ modelId: 'google-veo3.1-pro', duration: 8 }), 89);
  ...
  assert.equal(pricing.creditsFromCostMicros(135_000), 18);
